...
result number;
begin
result:=bill('49/47300099/48T','FEB-16','Short Timer');
end;
/
...
declare
 result number;
 begin
 result:=bill('86/49576948/32T','FEB-16','Flat Rate Lover');
 end;
 /

 SELECT contract_type FROM contracts WHERE contractId = 'GN65709/12';
